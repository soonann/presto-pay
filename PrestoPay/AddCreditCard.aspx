<%@ Page Title="" Language="C#" MasterPageFile="~/Client.Master" AutoEventWireup="true" CodeBehind="AddCreditCard.aspx.cs" Inherits="PrestoPay.AddCreditCard" %>
            ...
            <div class="col-sm-4 form-horizontal">
                ...
                <div class="form-group-sm">
                    <div class="col-sm-offset-3 col-sm-9">
                        <h1 class="prestoTitle whiteColor">Link a Credit Card</h1>
                    </div>
                ...
                <div class="form-group">
                     ...
                     <label class="control-label col-sm-4 whiteColor">Credit Card type:</label>
                    <div class="col-sm-8 ">
                        <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control"></asp:TextBox> 
                         <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="You are required to field a credit card type" ControlToValidate="TextBox1" ForeColor="Red"></asp:RequiredFieldValidator>
                    </div>

                    <label class="control-label col-sm-4 whiteColor">Credit Card Number:</label>
                    <div class="col-sm-8 ">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-4 whiteColor">CVS:</label>
                    <div class="col-sm-8 ">
                        <asp:TextBox ID="TextBox_cvc" runat="server" CssClass="form-control" ></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="You are required to field a number" ControlToValidate="TextBox_cvc" ForeColor="Red"></asp:RequiredFieldValidator>
                    </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4 whiteColor">Date of expiry:</label>
                    <div class="col-sm-8 ">
                        <asp:TextBox ID="TextBox_doe" runat="server" CssClass="form-control" type ="date" ></asp:TextBox>
                    </div>
                        </div>
