<%@ Page Title="" Language="C#" MasterPageFile="~/Client.Master" AutoEventWireup="true" CodeBehind="FundTransfer.aspx.cs" Inherits="PrestoPay.SummaryPage" %>
            ...
            <div class="row">
              ...
              <div class="row Panel">
                ...
                <asp:Panel class="Panel" ID="RequestPanel" runat="server" Visible="false" CssClass="col-sm-12"> <h3>Payee:</h3>
                    ...
                    <asp:TextBox ID="requestAmttb" runat="server"></asp:TextBox>
                    <span class="input-group-addon">$</span>
